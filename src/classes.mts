...
export interface cssInput {
  ...
  ALIGN_CONTENT?:
    ...
    | "end"
    | "flex-start"
    | "flex-end" /*there are more proppeties to add */;
  POSITION?:
    | "static"
    | "relative"
    | "absolute"
    | "fixed"
    | "sticky" /*css position propertey*/;
  ALIGN_ITEMS?:
    | "normal"
    | "stretch"
    | "center"
    ...
    | "baseline"
    | "initial"
    | "inherit" /*css Align items property */;
  ALIGN_SELF?:
    | "auto"
    | "stretch"
    | "center"
    ...
    | "baseline"
    | "initial"
    | "inherit" /*css align-self propertey*/;
  ALL?: "initial" | "inherit" | "unset" /*css all propertey*/;
  ANIMATION_DELAY?:
    | number
    | "initial"
    | "inherit" /*Css annimation dellay propertey*/;
  ANIMATION_DIRECTION?:
    | "normal"
    | "reverse"
    | "alternate"
    | "alternate-reverse"
    | "initial"
    | "inherit" /*css annimation directon propertey*/;
  ANIMATION_DURATION?:
    | number
    | "initial"
    | "inherit" /*CSS animation delay propertey*/;
  ANIMATION_FILL_MODE?:
    | "none"
    | "forwards"
    | "backwards"
    | "both"
    | "initial"
    | "inherit" /*css annimation fill mode propertey*/;
  ANIMATION_ITERATION_COUNT?:
    | number
    | "infinite"
    | "initial"
    | "inherit" /*CSS annimation itteration count propertey*/;
  ANIMATION_NAME?:
    | string
    | "none"
    | "initial"
    | "inherit" /*string is keyframe name*/;
  ANIMATION_PLAY_STATE?:
    | "paused"
    | "running"
    | "initial"
    | "inherit" /*css animation play state prop */;
  ANIMATION_TIMING_FUNCTION?:
    ...
    | "step-end"
    | "initial"
    | "inherit" /*there are more properties*/;
